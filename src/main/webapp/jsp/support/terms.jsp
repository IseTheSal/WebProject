...
<small style="left: 0;position: absolute;text-align: left;margin-left: 30%; white-space: pre-line">
    ...
    of the website. IseTheSal does not filter, edit, publish or review Comments prior to their presence on the website.
    Comments do not reflect the views and opinions of IseTheSal,its agents and/or affiliates. Comments reflect the views
    and opinions of the person who post their views and opinions. To the extent permitted by applicable laws, IseTheSal
    ...
    IseTheSal reserves the right to monitor all Comments and to remove any Comments which can be considered
    ...
    activity.
    You hereby grant IseTheSal a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce
    ...
    with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of IseTheSal; and (d)
    ...
    must inform us by sending an e-mail to IseTheSal. Please include your name, your organization name, contact
    ...
    No use of IseTheSal's logo or other artwork will be allowed for linking absent a trademark license agreement.
    ...
    Please double-check the data you entered. The store is not responsible for an incorrectly specified email address or
    loss of password.
